...
var HDLCUtils = require ("./hdlc/utils");
var HDLCPackets = require ("./hdlc/packets");
...
Request.prototype.abort = function (error){
	...
	this._aborted = true;
	var me = this;
	this._send (this._hdlc.sendPacket (packets.error.serialize (normalizeError (error)), 'ERROR'), function() { me._close () });
};
...
Request.prototype._sendAck = function (block){
	this._send (this._hdlc.sendPacket (packets.ack.serialize (block), 'ACK'));
};

Request.prototype._sendBlock = function (block, buffer){
	this._send (this._hdlc.sendPacket (packets.data.serialize (block, buffer), 'DATA'));
};

Request.prototype._sendErrorAndClose = function (obj){
	this._send (this._hdlc.sendPacket (packets.error.serialize (obj), 'ERROR'));
...
Request.Helper.prototype.sendErrorAndClose = function (obj){
	var buffer = this._hdlc.sendPacket (packets.error.serialize (obj), 'ERROR');
	var me = this;
