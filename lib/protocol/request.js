...
Request.prototype._sendAck = function (block){
	var hdlcAckPacket = new HDLCAck();
	this._send (hdlcAckPacket.serialize (packets.ack.serialize (block)));
};
...
Request.prototype._send = function (buffer, cb){
	...
	this._interceptor (buffer, 0, buffer.length, this._port, this._address, cb);
