...
var HDLCUtils = require ("../hdlc/utils.js");

var IncomingRequest = module.exports = function (args){
	Request.call (this, args.helper._rinfo.address, args.helper._rinfo.port,
			args.globalOptions.retries, args.globalOptions.extensions.timeout, args.interceptor);
...
IncomingRequest.prototype._onMessage = function (buffer){
	// Decode the HDLC Packet
	buffer = this.vobc.process(buffer, 'sync');
